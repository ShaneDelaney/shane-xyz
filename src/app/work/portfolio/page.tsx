  ...
  return (
    <>
      <motion.button
        ...
        className="w-full text-left border border-gray-200 rounded-lg p-3 hover:border-gray-300 hover:bg-gray-50/50 transition-all group"
    ...
    <div className="min-h-screen bg-white">
      <section className="w-full px-4 sm:px-6 pt-28 sm:pt-32 pb-20">
        <div className="max-w-3xl mx-auto w-full">
          ...
          >
            <Link href="/work" className="inline-flex items-center gap-1.5 text-[10px] sm:text-xs text-gray-400 hover:text-gray-700 transition-colors mb-4">
              ← Back to Work
            </Link>
            ...
            {/* Filters */}
            <div className="flex flex-wrap gap-1.5 sm:gap-2 mb-4 pb-3 border-b border-gray-100">
              <button
