...
const CARDS: Card[] = [
...

  {
    ...
    hook: 'Analyzed high-velocity engagement signals daily to identify emerging cultural trends before they peaked.',
    about: 'Systematic daily analysis of Spotlight engagement data — completion rates, watch time velocity, and audience behavior patterns — to surface breakout cultural formats and inform real-time programming decisions.',
    impact: 'Synthesized performance data into actionable trend reports used by the programming team for amplification decisions. Developed a repeatable framework for distinguishing genuine cultural signal from noise at scale.',
    period: 'Mar – Oct 2025',
    tags: ['Trend Analysis', 'Cultural Intelligence', 'Data Synthesis', 'Programming'],
    metrics: ['1,000+', 'videos reviewed daily'],
    bg: 'linear-gradient(145deg, #111111 0%, #1c1c1c 100%)',
    accent: '#FDE047',
  },
  {
  ...
  },
  {
    ...
    hook: 'Editorial programming judgment applied to marketing — identifying UGC that could hold up at national scale.',
    about: 'Sourced standout user-generated content for Snap marketing activations including the Say It in a Snap campaign — identifying high-performing Snaps with the visual quality and cultural resonance to translate into large-scale advertising placements.',
    impact: 'Contributed content selections that went to Times Square subway placements and national campaign usage — demonstrating that programming-level editorial judgment extends well beyond the feed.',
    period: 'Mar – Oct 2025',
    tags: ['Campaign Sourcing', 'UGC', 'Marketing', 'Brand Activation'],
    bg: 'linear-gradient(145deg, #111111 0%, #1c1c1c 100%)',
    accent: '#FDE047',
  },
  {
  ...
  },
  {
    ...
    hook: 'Programming insights feeding directly into product iteration — not just the feed.',
    about: 'Worked with product and engineering teams to test new feed curation strategies and user experience surfaces, contributing editorial and programming insights that informed product development cycles.',
    impact: 'Contributed directly to new user onboarding feed improvements and supported experimentation cycles across Spotlight surfaces. Achieved 10% higher retention than platform average on curated NUX cohorts.',
    period: 'Mar – Oct 2025',
    tags: ['Product Collaboration', 'XFN', 'Engineering', 'UX'],
  ...
  // ── PHONY CONTENT ─────────────────────────────────────────────────────────
  {
    ...
    metrics: ['6.3M views', '39% completion'],
  ...
  },
  {
    ...
    metrics: ['4.39M views', '42% completion'],
    bg: 'linear-gradient(145deg, #180D35 0%, #240f4f 100%)',
    accent: '#C084FC',
  },
  {
    ...
    about: 'Third highest-performing story in the Tiny Texts catalog — part of a series that built a documented, replicable editorial system for scripted short-form content.',
    ...
    period: '2024–2025',
    tags: ['Scripted Series', 'Editorial Operations', 'Snapchat'],
    metrics: ['3.59M views', '35% completion'],
    bg: 'linear-gradient(145deg, #180D35 0%, #240f4f 100%)',
    accent: '#C084FC',
  },
