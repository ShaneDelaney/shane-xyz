        ...
        <div className="max-w-3xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-600 leading-relaxed max-w-2xl mx-auto">
              I'm always open to connecting about content strategy, creative marketing, or storytelling in tech.
              Reach out for collaborations or opportunities — or just to talk ideas.
            </p>
          </motion.div>
          
          {/* Direct Contact Info */}
          <motion.div
            className="mb-12 bg-white border border-gray-200 rounded-2xl p-6 sm:p-8"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
